...
Eigen::Matrix3d Movable::MakeTrans3d()
{

	Eigen::Matrix4d trans4d = (Tout.matrix() * Tin.matrix());
	Eigen::Matrix3d trans3d;
	trans3d.row(0) << trans4d(0, 0), trans4d(0, 1), trans4d(0, 2);
	trans3d.row(1) << trans4d(1, 0), trans4d(1, 1), trans4d(1, 2);
	trans3d.row(2) << trans4d(2, 0), trans4d(2, 1), trans4d(2, 2);
	return trans3d;
}
