...
IGL_INLINE void igl::opengl::MeshGL::bind_cubemap() { glUseProgram(shader_cubemap); }

IGL_INLINE void igl::opengl::MeshGL::draw_cubemap() { glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0); }
