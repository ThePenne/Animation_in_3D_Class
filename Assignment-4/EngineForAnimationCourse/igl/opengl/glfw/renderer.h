...
public:
	...
	inline void Animate() { scn->Animate(core()); }
	...
	void pause_game() { menu->menu_mode = igl::opengl::glfw::imgui::ImGuiMenu::pause_screen; }
	bool in_game() { return menu->menu_mode == igl::opengl::glfw::imgui::ImGuiMenu::game_hud; }
